...
APPROVAL_STATUS_PROBATION = 'P'
APPROVAL_STATUS_APPROVED = 'A'
APPROVAL_STATUS_RESTRICTED = 'R'

APPROVAL_STATUS_TYPES = (
    (APPROVAL_STATUS_PROBATION, 'Probation / Unassessed'),
    (APPROVAL_STATUS_APPROVED, 'Approved'),
    (APPROVAL_STATUS_RESTRICTED, 'Restricted / Do Not Use'),
)
...
ROLE_TYPE_VIEWER = 'V'
ROLE_TYPE_EDITOR = 'E'
ROLE_TYPES = ((ROLE_TYPE_ADMIN, 'Admin'), (ROLE_TYPE_EDITOR, 'Editor'), (ROLE_TYPE_VIEWER, 'Viewer'),)

# Part-class approval workflows (CHIT-001 Phase D)
NUMBER_WORKFLOW_TRANSITIONS_MAX = 20

CONFIGURATION_TYPE_DRAFT = 'D'
CONFIGURATION_TYPE_IN_REVIEW = 'I'
CONFIGURATION_TYPE_RELEASED = 'R'
CONFIGURATION_TYPE_OBSOLETE = 'O'
CONFIGURATION_TYPES = (
    (CONFIGURATION_TYPE_DRAFT, 'Draft'),
    (CONFIGURATION_TYPE_IN_REVIEW, 'In Review'),
    (CONFIGURATION_TYPE_RELEASED, 'Released'),
    (CONFIGURATION_TYPE_OBSOLETE, 'Obsolete'),
)
